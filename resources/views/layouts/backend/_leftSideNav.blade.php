<!-- User Info -->
<div class="user-info">
    <div class="image"> <img src="{{asset('theme/admin/assets/images/random-avatar1.jpg')}}" width="48" height="48" alt="User" /> </div>
...
<div class="menu">
    <ul class="list">
        ...
        <li class="active"> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a>
            <ul class="ml-menu">
                <li class="active"><a href="index.html">Dashboard 1</a> </li>
                <li><a href="index2.html">Dashboard 2</a></li>
            </ul>
        </li>
        <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-email"></i><span>Settings</span> </a>
            <ul class="ml-menu">
        ...
        <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-swap-alt"></i><span>Users</span> </a>
            <ul class="ml-menu">
