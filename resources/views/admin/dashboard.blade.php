                    ...
                    <ul class="inbox-widget list-unstyled clearfix">
                        <li class="inbox-inner" data-aos-duration="400" data-aos-delay="100" data-aos="fade-down"> <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-img"> <img src="{{asset('theme/admin/assets/images/random-avatar3.jpg')}}" alt=""> </div>
                        ...
                        <li class="inbox-inner" data-aos-duration="400" data-aos-delay="200" data-aos="fade-down"> <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-img"> <img src="{{asset('theme/admin/assets/images/random-avatar2.jpg')}}" alt=""> </div>
                                    <div class="inbox-item-info">
                                        <p class="author">John Doe</p>
                        ...
                        <li class="inbox-inner" data-aos-duration="400" data-aos-delay="300" data-aos="fade-down"> <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-img"> <img src="{{asset('theme/admin/assets/images/random-avatar4.jpg')}}" alt=""> </div>
                                    <div class="inbox-item-info">
                                        <p class="author">John Doe</p>
                ...
                <div class="body">
                    <div class="chat-widget">
                        <ul class="chat-scroll-list">
                            <li class="left float-left"> <img src="{{asset('theme/admin/assets/images/random-avatar4.jpg')}}" alt="">
                            ...
                            <li class="right"> <img src="{{asset('theme/admin/assets/images/random-avatar2.jpg')}}" alt="">
                            ...
                            <li class="left float-left"> <img src="{{asset('theme/admin/assets/images/random-avatar5.jpg')}}" alt="">
                                <div class="chat-info"> <a class="name" href="#">Jone Doe</a> <span class="datetime">6:12</span> <span class="message"> Lorem ipsum dolor sit amet, consectetuer adipiscing elit </span> </div>
                            </li>
                            <li class="right"> <img src="{{asset('theme/admin/assets/images/random-avatar1.jpg')}}" alt="">
                                <div class="chat-info"> <a class="name" href="#">Jone Doe</a> <span class="datetime">6:12</span> <span class="message"> Lorem ipsum dolor sit amet, consectetuer adipiscing elit </span> </div>
                            </li>
                        </ul>
                    </div>
